...
**Solution**: Use llama3.1:8b (best for tool calling) or Claude. See `docs/OLLAMA_MODEL_COMPARISON.md` for model recommendations.
...
| LLM tool call reliability | Some models don't reliably follow tool format | Use llama3.1:8b |
